...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # apply causal mask (remove upper-triangle elements)
...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.transformer = nn.ModuleDict(dict(
            ...
            h = nn.ModuleList([Transformer(GPTConfig) for _ in range(GPTConfig.n_layer)]),
            # additional layer added in GPT2
            ln_f = nn.LayerNorm(self.GPTConfig.n_embd)
        ))
        self.lm_head = nn.Linear(self.GPTConfig.n_embd, self.GPTConfig.vocab_size, bias=False)
    ...
    def from_pretrained(cls, pretrained_model_name_or_path):
        ...
        assert pretrained_model_name_or_path in {'gpt2', 'gpt2-medium', 'gpt2-large', 'gpt2-xl'}
